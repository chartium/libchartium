...
export function randomContrastingColor(seed?: string, contrastWithLight = true, contrastWithDark = true): Color {
  ...
  if (contrastWithDark && l < 0.55 && (210 * deg < h || h < 10 * deg)) {
    return randomContrastingColor(seed, contrastWithLight, contrastWithDark);
  }
